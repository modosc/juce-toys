...
public:
  ...
  public:
    ...
    void paintItem (Graphics& g, int w, int h)
    {
      ...
      g.drawText (propertySummary, (int) rint(propertyX), 0, w - (int) rint(propertyX), h, Justification::left, true);
    }
    ...
    void valueTreePropertyChanged (ValueTree& treeWhosePropertyHasChanged, [[maybe_unused]] const Identifier& property)
    {
    ...
    void valueTreeChildAdded (ValueTree& parentTree, [[maybe_unused]] ValueTree& childWhichHasBeenAdded)
    {
      if (parentTree == t)
        updateSubItems();
    ...
    void valueTreeChildRemoved (ValueTree& parentTree, [[maybe_unused]] ValueTree& childWhichHasBeenRemoved, int)
    {
      if (parentTree == t)
        updateSubItems();
    ...
    void valueTreeParentChanged ([[maybe_unused]] ValueTree& treeWhoseParentHasChanged)
    {
      treeHasChanged();
    }
